...
<html>
  ...
  <body> 
    ...
    <br><form method="post" action="../servlet/ConfigManage.do" name="form1">
   <table class=table>
<tbody>
...
<td><input type="radio" value="true" name="siteOpen"  <%=cfg.getCIsOpen()?"checked":"" %>>开启  <input type="radio" value="false" name="siteOpen" <%=cfg.getCIsOpen()?"":"checked" %>>关闭</td>
<td>&nbsp;</td></tr>
<tr>
<td>&nbsp;关闭原因：</td>
...
<tr><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td></tr><tr><td valign="top"><br></td><td valign="top" align="center">  <input type="submit" value="提交" name="button2">&nbsp;&nbsp;&nbsp;<input type="reset" value="取消" name="button3"></td><td valign="top"><br></td></tr><tr><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td></tr>
