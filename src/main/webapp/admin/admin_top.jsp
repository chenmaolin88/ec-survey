...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgColor=#3a6592 style="color:#FFFFFF; font-size:12px;">
  <tr>
    <td height="28" width="214"><a href="http:///" target="_blank"><IMG src="images/Title.gif" border="0"></a></td>
    <td width="68" nowrap="nowrap">&nbsp;</td>
    <td width="326">&nbsp;</td>
    <td width="21">&nbsp;</td>
    <td width="*" align="right" nowrap="nowrap">
	  [<A class=blue href="#" onClick="showModalDialog('AboutSys.jsp',window,'dialogHeight:300px;dialogWidth:360px;dialogleft:350px;help:no;status:no;scroll:no');">关于系统</A>]
