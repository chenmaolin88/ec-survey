...
public class QuestionManage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("AddQuestion".equals(op)){
			...
			if(ret==true)
				response.sendRedirect(request.getContextPath()+"/admin/OpResult.jsp?op=Question&ret=true&sid="+sid);
			else{
				response.sendRedirect(request.getContextPath()+"/admin/OpResult.jsp?op=Question&ret=false");
			}
			...
			if(ret==true)
				response.sendRedirect(request.getContextPath()+"/admin/QuestionAdmin.jsp?sid="+sid);
			else
				response.sendRedirect(request.getContextPath()+"/admin/OpResult.jsp?op=Question&ret=false");
