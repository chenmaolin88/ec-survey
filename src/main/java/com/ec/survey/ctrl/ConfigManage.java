...
public class ConfigManage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (ret==true)
			response.sendRedirect(request.getContextPath()+"/admin/OpResult.jsp?op=SysConfig&ret=true");
		else
			response.sendRedirect(request.getContextPath()+"/admin/OpResult.jsp?op=SysConfig&ret=false");
